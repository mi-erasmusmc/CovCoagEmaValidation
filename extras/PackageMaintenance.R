...
#
# This file is part of CovCoagEmaValidation
#
...
OhdsiRTools::checkUsagePackage("CovCoagEmaValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CovCoagEmaValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovCoagEmaValidation.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CovCoagEmaValidation")
