...
Guide
============
A general guide for running a valdiation study package is available here: [Skeleton Validation Study guide](https://github.com/OHDSI/CovCoagEmaValidation/tree/master/inst/doc/UsingSkeletonValidationPackage.pdf)
...
projectFolder <- "C:/CovCoagEmaValidation"
...
download.file("https://raw.githubusercontent.com/ohdsi-studies/CovCoagEmaValidation/master/renv.lock", "renv.lock")
...
devtools::install_github("ohdsi-studies/CovCoagEmaValidation")
```
...
===============
  ...
  2. In R, run the code in 'extras/codeToRun.R' (see [Skeleton Validation Study guide](https://github.com/OHDSI/CovCoagEmaValidation/tree/master/inst/doc/UsingSkeletonValidationPackage.pdf) for guideance)
...
cohortTable <- 'CovCoagEmaValidationCohortTable'
